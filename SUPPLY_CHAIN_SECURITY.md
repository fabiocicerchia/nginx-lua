...
Signatures are attached to the **index image** (multi-arch manifest list),
not to individual per-arch images.
...
platform-specific packages differ) and attached to the index image digest.
