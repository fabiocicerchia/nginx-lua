...
ARG VER_OPENRESTY_STREAMLUA=97937e20b8be8f972de4e99672a038012b540dbf
...
LABEL maintainer="Fabio Cicerchia <info@fabiocicerchia.it>" \
    ...
    org.label-schema.description="Nginx ${VER_NGINX} with Lua support based on alpine (${ARCH}) 3.20.1." \
    org.label-schema.docker.cmd="docker run -p 80:80 -d ${DOCKER_IMAGE}:${VER_NGINX}-alpine3.20.1" \
    ...
    org.label-schema.version="${VER_NGINX}-alpine3.20.1" \
