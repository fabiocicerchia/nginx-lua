...
If there are any vulnerabilities in nginx-lua, don't hesitate to report them
using the contact options listed on this [GitHub profile](https://github.com/fabiocicerchia).

A machine-readable security contact is available at
[.github/security.txt](.github/security.txt) per [RFC 9116](https://www.rfc-editor.org/rfc/rfc9116).
...
In accordance with the **EU Cyber Resilience Act (CRA) Article 11** and
...
- **Signed** with [cosign](https://github.com/sigstore/cosign) (Sigstore)
- **Scanned** for vulnerabilities with [Trivy](https://github.com/aquasecurity/trivy)
- **Accompanied by a signed SBOM** in CycloneDX format

See [SUPPLY_CHAIN_SECURITY.md](SUPPLY_CHAIN_SECURITY.md) for full details.
