...
# Production ready.
ARG VER_LUA_NGINX_MODULE=0.10.29R2
ENV VER_LUA_NGINX_MODULE=$VER_LUA_NGINX_MODULE

# lua-resty-core
# https://github.com/openresty/lua-resty-core
# This library is production ready.
ARG VER_LUA_RESTY_CORE=0.1.32R1
...
ARG VER_OPENRESTY_STREAMLUA=4fbaf9c929f850172257dab2c168306c06b305e5
...
LABEL maintainer="Fabio Cicerchia <info@fabiocicerchia.it>" \
    ...
    org.label-schema.description="Nginx ${VER_NGINX} with Lua support based on alpine (${ARCH}) 3.23.2." \
    org.label-schema.docker.cmd="docker run -p 80:80 -d ${DOCKER_IMAGE}:${VER_NGINX}-alpine3.23.2" \
    ...
    org.label-schema.version="${VER_NGINX}-alpine3.23.2" \
