...
ARG VER_OPENRESTY_STREAMLUA=3096b45c7da614d834a2280f8c048eaaa76047bc
...
LABEL maintainer="Fabio Cicerchia <info@fabiocicerchia.it>" \
    ...
    org.label-schema.description="Nginx ${VER_NGINX} with Lua support based on alpine (${ARCH}) 3.22.0." \
    org.label-schema.docker.cmd="docker run -p 80:80 -d ${DOCKER_IMAGE}:${VER_NGINX}-alpine3.22.0" \
    ...
    org.label-schema.version="${VER_NGINX}-alpine3.22.0" \
